...
// for custom
Color primary = Color.fromRGBO(25, 195, 251, 1);
...
TextStyle bodyText12Small({required Color color, double? spacing}) {
  return TextStyle(
      fontSize: 12, color: color, fontWeight: FontWeight.w400, height: spacing);
}

TextStyle bodyText11Small({required Color color, double? spacing}) {
  return TextStyle(
      fontSize: 11, color: color, fontWeight: FontWeight.w400, height: spacing);
}

TextStyle bodytext12Bold({required Color color, double? spacing}) {
  return TextStyle(
      fontSize: 12, color: color, fontWeight: FontWeight.w600, height: spacing);
}

TextStyle bodyText20w700({required Color color, double? spacing}) {
  return TextStyle(
      fontSize: 20, color: color, fontWeight: FontWeight.bold, height: spacing);
}

TextStyle bodyText22w700({required Color color, double? spacing}) {
  return TextStyle(
      fontSize: 22, color: color, fontWeight: FontWeight.bold, height: spacing);
}
